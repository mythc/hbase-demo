...
//        HColumnDescriptor columnDescriptor = new HColumnDescriptor("personal");

        admin.deleteColumn(TableName.valueOf("demo"),"personal".getBytes());
        System.out.println("columen deleted");
    }
}
