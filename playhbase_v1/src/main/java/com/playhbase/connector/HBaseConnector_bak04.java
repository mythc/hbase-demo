 ...
 * Hello world!
 */
public class HBaseConnector_bak04 {
    ...
    public HBaseConnector_bak04() throws IOException {
...
//        table = conn.getTable(TableName.valueOf(tableName));
    ...
    public void getRanking(String[] devIds, String startTime, String stopTime, List<Map<String, Double>> list) {
...
//        List<Map<String, Double>> list = new ArrayList<Map<String, Double>>();
        ...
        for (String devid : devIds) {
            ...
            try {
                ...
                map.put(devid, 0.0); //所给的时间范围内没有该设备的数据
            }
            list.add(map);
        }
    ...
    public static void main(String[] args) {
        ...
        HBaseConnector_bak04 hc = null;
        try {
            hc = new HBaseConnector_bak04();
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//
//        hc.scanTables(devIds[0], "1527068560736", "1527073735865", list);

//        System.out.println(list);

//        hc.getRanking(devIds, "1527068560736", "1527093414609", jsonArray);
//        System.out.println(hc.scanLastData(devIds[0], "1527068560736", "1527093414609"));
